import { QUIZ_ITEMS, QUIZ_SECTIONS } from "./quizData.js?v=20260704v1";
import { sectionLabel, renderSessionSummary } from "./quizSummary.js?v=20260704v1";
import { downloadWord, printSheet } from "./quizExport.js?v=20260704v1";
import {
  DIFFICULTY_LEVELS,
  difficultyLevel,
  seededShuffle,
  ...
  buildQuizBankStats,
  filterQuizPool,
} from "./quizUtils.js?v=20260704v1";
import {
  animateSplitText,
  bindMagnets,
  bindTrueFocus,
  ...
  initSettingsToggle,
} from "./quizEffects.js?v=20260704v1";
...
const UI = {
  en: {
    ...
    txtPracticeHint: "Wrong answer: model answer is shown.",
    ...
    summaryWrongTitle: "Wrong — review these",
    summaryNoneWrong: "None — all answered correctly on first attempt.",
    ...
    revBandFair: "Mixed performance: re-read Topic 3 metals notes for weaker topics, then regenerate.",
    revBandLow:
      "Several concepts need consolidation. Review extraction, reactivity series, displacement, rusting and mole calculations before the next round.",
    ...
    lastQuestions.forEach((q, idx) => {
      ...
      btn.addEventListener("click", () => {
        ...
        if (ok) {
          ...
          try {
            ...
            window.postMessage({
              ...
              subject: 'CHEM',
              quizId: 'chem-topic3-metals-exercise',
              questionId: q.id,
              section: q.section,
        ...
        if (fmt !== "fill") {
          ...
          fillInputs.forEach((inp) => {
            inp.disabled = true;
            inp.classList.add("border-tertiary");
          });
        }
