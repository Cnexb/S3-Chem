...
export function downloadWord(questions, answersMode, lang) {
  ...
  const titleEn = answersMode
    ? "Topic 3 Metals — Answers"
    : "Topic 3 Metals — Questions";
  const titleZh = answersMode ? "第三課題 金屬 — 答案" : "第三課題 金屬 — 試題";
  ...
  a.download = (answersMode ? "metals_answers_" : "metals_questions_") + ts + ".doc";
  a.click();
