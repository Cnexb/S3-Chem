...
var Burette = (function () {
  ...
  /* Aligned to SVG graduation marks: 0 at y=72, 50 at y=302 */
  var SCALE_ZERO_Y = 72;
  var SCALE_SPAN = 230;
  var LIQUID_BOTTOM_Y = 308;
  var LIQUID_X = 159;
  var LIQUID_W = 22;
  ...
  function positionStopcockHint() {
    ...
    var gap = 18;
    var left = tapCenterX + gap + 20;
    var top = tapCenterY - hintH / 2;

    var sceneW = sceneRect.width;
    if (left + 200 > sceneW - 80) {
      left = Math.max(tapCenterX + gap + 20, sceneW * 0.42);
    }
  ...
  function initHint() {
    ...
    if (dismissed) {
      ...
      if (pulse) pulse.setAttribute('visibility', 'visible');
